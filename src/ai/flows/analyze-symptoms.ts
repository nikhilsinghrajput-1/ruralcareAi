...
const AnalyzeSymptomsOutputSchema = z.object({
  ...
  recommendedAction: z.string().describe('The single, most important next action for the healthcare worker to take. This will be the task description.'),
  suggestedTaskTitle: z.string().describe('A short, actionable title for the suggested follow-up task for a Community Health Worker.')
});
...
5. A short, actionable title for this next action that can be used as a task title. For example: "Perform Malaria RDT", "Schedule 3-day follow-up", "Refer to clinic".
